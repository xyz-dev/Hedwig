...
public class HedwigExecutors {
	...
	public static ThreadPoolExecutor newCachedThreadPool(BlockingQueue<Runnable> eventQueue) {
		int coreSize = ProperitesContainer.getInstance().getIntProperty(PropKeyConstants.HEDWIG_SYNC_POOL_CORESIZE,
				InternalConstants.DEFAULT_SYNC_POOL_CORESIZE);
		int maxSize = ProperitesContainer.getInstance().getIntProperty(PropKeyConstants.HEDWIG_SYNC_POOL_MAXSIZE,
				InternalConstants.DEFAULT_SYNC_POOL_MAXSIZE);
		long idleTime = ProperitesContainer.getInstance().getLongProperty(PropKeyConstants.HEDWIG_SYNC_POOL_IDLETIME,
	...
	public static ScheduledThreadPoolExecutor newSchedulerThreadPool() {
		int coreSize = ProperitesContainer.getInstance().getIntProperty(PropKeyConstants.HEDWIG_SCHEDULER_POOL_CORESIZE,
				InternalConstants.DEFAULT_SCHEDULER_POOL_CORESIZE);
		int maxSize = ProperitesContainer.getInstance().getIntProperty(PropKeyConstants.HEDWIG_SCHEDULER_POOL_MAXSIZE,
				InternalConstants.DEFAULT_SCHEDULER_POOL_MAXSIZE);
		long idleTime = ProperitesContainer.getInstance().getIntProperty(PropKeyConstants.HEDWIG_SCHEDULER_POOL_IDLETIME,
